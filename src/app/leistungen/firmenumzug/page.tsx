...
export const metadata: Metadata = buildMetadata({
  title: "Firmenumzug Berlin – ab 79 €/Std. mit klarer Projektplanung",
  description:
    "Firmenumzug in Berlin ab 79 €/Std. inklusive 2 Mitarbeiter und Fahrzeug. Für Unternehmen, Kanzleien, Praxen und Agenturen mit transparenter Ablaufplanung.",
  path: "/leistungen/firmenumzug",
});

const benefits = [
  "Minimale Ausfallzeit durch abgestimmte Meilensteinplanung",
  "IT-sicherer Transport von Monitoren, Servern und sensiblen Geräten",
...
const includedServices = [
  ...
  "IT- und Technikhandling nach Absprache",
  "Etagen- und Zugangsplanung",
  "Auf Wunsch: Halteverbotszonen",
  "Auf Wunsch: Grundreinigung der neuen Fläche",
];
...
const faqItems = [
  ...
  {
    question: "Was kostet ein Firmenumzug?",
    answer:
      "Firmenumzüge starten bei 79 €/Std. inklusive 2 Mitarbeiter und Fahrzeug. Der endgültige Aufwand richtet sich nach Volumen, Etage, Laufwegen, Zeitfenster und gewünschtem Zusatzservice.",
  },
  {
    question: "Wie läuft die Projektplanung ab?",
    answer:
      "Zunächst erfassen wir Rahmendaten wie Größe, Etage, Technikumfang und Zeitrahmen. Daraus entsteht ein Ablaufplan mit klaren Zuständigkeiten.",
  },
];
    ...
    <>
      ...
      <section className="bg-[linear-gradient(135deg,#0d1724_0%,#112132_52%,#173832_100%)] py-20 md:py-28">
        <div className="mx-auto max-w-5xl px-4 text-center md:px-8">
          ...
          <h1 className="mt-6 text-4xl font-bold text-white md:text-5xl">Firmenumzug Berlin – klar geplant und transparent kalkuliert</h1>
          <p className="mx-auto mt-5 max-w-3xl text-lg leading-8 text-slate-300">
            Für Unternehmen, Kanzleien, Praxen und Agenturen koordinieren wir Arbeitsplätze, Technik und Übergaben mit realistischer Planung und transparenter Preislogik.
          </p>
          <div className="mt-8 flex flex-col justify-center gap-4 sm:flex-row">
            <Link href="/buchen?service=MOVING&variant=business" className="btn-primary-glass inline-flex items-center justify-center gap-2 px-6 py-3.5 text-sm font-semibold">
              Firmenumzug anfragen <ArrowRight size={16} />
            </Link>
      ...
      <section className="py-20">
        <div className="mx-auto max-w-3xl px-4 text-center md:px-8">
          ...
          <div className="mt-6 flex flex-col justify-center gap-3 sm:flex-row">
            ...
            <Link href="/kontakt?subject=Festpreisanfrage%20-%20Firmenumzug" className="btn-secondary-glass px-6 py-3.5 text-sm font-semibold">
              Festpreis anfragen
            </Link>
          </div>
        </div>
      ...
      <section className="bg-[linear-gradient(135deg,#0d1724_0%,#112132_52%,#173832_100%)] py-20">
        <div className="mx-auto max-w-4xl px-4 text-center md:px-8">
          ...
          <p className="mt-5 text-lg text-white/75">
            Kontaktieren Sie uns für eine individuelle Projektplanung. Sie erhalten ein unverbindliches Angebot mit klarem Ablaufplan und nachvollziehbarer Kalkulation.
          </p>
          <div className="mt-8 flex justify-center gap-4">
            <Link href="/kontakt?subject=Firmenumzug%20Anfrage" className="btn-primary-glass inline-flex items-center justify-center gap-2 px-6 py-3.5 text-sm font-semibold">
